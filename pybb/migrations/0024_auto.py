...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field visible_to_user on 'Forum'
        db.create_table('pybb_forum_visible_to_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('forum', models.ForeignKey(orm['pybb.forum'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('pybb_forum_visible_to_user', ['forum_id', 'user_id'])

        # Adding M2M table for field visible_to_group on 'Forum'
        db.create_table('pybb_forum_visible_to_group', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('forum', models.ForeignKey(orm['pybb.forum'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('pybb_forum_visible_to_group', ['forum_id', 'group_id'])

        # Adding M2M table for field visible_to_user on 'Category'
        db.create_table('pybb_category_visible_to_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm['pybb.category'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('pybb_category_visible_to_user', ['category_id', 'user_id'])

        # Adding M2M table for field visible_to_group on 'Category'
        db.create_table('pybb_category_visible_to_group', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm['pybb.category'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('pybb_category_visible_to_group', ['category_id', 'group_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field visible_to_user on 'Forum'
        db.delete_table('pybb_forum_visible_to_user')

        # Removing M2M table for field visible_to_group on 'Forum'
        db.delete_table('pybb_forum_visible_to_group')

        # Removing M2M table for field visible_to_user on 'Category'
        db.delete_table('pybb_category_visible_to_user')

        # Removing M2M table for field visible_to_group on 'Category'
        db.delete_table('pybb_category_visible_to_group')
    ...
    models = {
        ...
        'pybb.category': {
            ...
            'visible_to_group': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'category_visible'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.Group']"}),
            'visible_to_user': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'category_visible'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"})
        },
        'pybb.forum': {
            ...
            'visible_to_group': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'forums_visible'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.Group']"}),
            'visible_to_user': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'forums_visible'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"})
        },
        ...
        'pybb.profile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'Italian'", 'max_length': '10', 'blank': 'True'}),
            'post_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            ...
            'utente_confermato': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'pybb.topic': {
