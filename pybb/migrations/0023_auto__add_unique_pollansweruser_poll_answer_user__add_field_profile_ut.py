...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.utente_confermato'
        db.add_column('pybb_profile', 'utente_confermato', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.utente_confermato'
        db.delete_column('pybb_profile', 'utente_confermato')
